...
import { queryLaunchBoxGenreAndLocalMultiplayer } from "../src/metadata/launchbox/launchbox";
...
describe("launchbox", () => {
    it("should lookup genres + local multiplayer from a minimal Metadata.xml", async () => {
        ...
        const res = await queryLaunchBoxGenreAndLocalMultiplayer("Some Game", platform, { enabled: true, xmlPath });
